...
/**
 * Processes a set of discrete events that act on some simulator state.
 * 
 ...
 * "discrete events" it will be running, whereby it delegates these details
...
public:
	 ...
	 */
	DiscreteEventSimulator() : simulationDuration(0)
	{
	}
	 ...
	 */
	bool addEvent(DiscreteEvent<TTime, TState> *event);
